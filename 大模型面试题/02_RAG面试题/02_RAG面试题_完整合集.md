...
- [RAG 面试题介绍](#RAG 面试题介绍)
- [1. 什么是 RAG？详细描述一个完整 RAG 系统的详细工作流程？](#1. 什么是 RAG？详细描述一个完整 RAG 系统的详细工作流程？)
- [2. 大模型的 RAG 主要用来解决什么问题？](#2. 大模型的 RAG 主要用来解决什么问题？)
- [3. 相比直接微调 LLM，RAG 解决了什么问题？微调和 RAG 各自的优劣势是什么？](#3. 相比直接微调 LLM，RAG 解决了什么问题？微调和 RAG 各自的优劣势是什么？)
- [4. RAG 中的文档是怎么存的？粒度是多大？详细说说文档切割（Chunking）策略？](#4. RAG 中的文档是怎么存的？粒度是多大？详细说说文档切割（Chunking）策略？)
- [5. 怎么规避语义被切割掉的问题？](#5. 怎么规避语义被切割掉的问题？)
- [6. 在 RAG 中 Embedding 究竟是什么？如何选择和评估一个 Embedding 模型？](#6. 在 RAG 中 Embedding 究竟是什么？如何选择和评估一个 Embedding 模型？)
- [7. Embedding 有哪几种算法你了解过吗？](#7. Embedding 有哪几种算法你了解过吗？)
- [8. 什么是向量数据库？有没有做过向量数据库的对比选型？](#8. 什么是向量数据库？有没有做过向量数据库的对比选型？)
- [9. 讲讲你用的向量数据库？数据量级是多大？性能如何？遇到过性能瓶颈吗？](#9. 讲讲你用的向量数据库？数据量级是多大？性能如何？遇到过性能瓶颈吗？)
- [10. 你使用 RAG 给大模型一个输入，系统是怎样的工作流程？](#10. 你使用 RAG 给大模型一个输入，系统是怎样的工作流程？)
- [11. 请你介绍一下向量检索和关键词检索的区别？](#11. 请你介绍一下向量检索和关键词检索的区别？)
- [12. 如何润色用户的 Query（Query Rewrite）？目的是什么？](#12. 如何润色用户的 Query（Query Rewrite）？目的是什么？)
- [13. 什么是多路召回？具体怎么做？](#13. 什么是多路召回？具体怎么做？)
- [14. RAG 检索优化策略有哪些？](#14. RAG 检索优化策略有哪些？)
- [15. 了解哪些更复杂的 RAG 范式？](#15. 了解哪些更复杂的 RAG 范式？)
- [16. 在什么场景下，你会选择使用图数据库来增强传统的向量检索？](#16. 在什么场景下，你会选择使用图数据库来增强传统的向量检索？)
- [17. 如何规避 RAG 系统中大模型的幻觉？](#17. 如何规避 RAG 系统中大模型的幻觉？)
- [18. 怎么量化你的 RAG 效果？](#18. 怎么量化你的 RAG 效果？)
- [19. RAG 知识库如何实现动态与持续更新？](#19. RAG 知识库如何实现动态与持续更新？)
- [20. 在实际落地中，你觉得 RAG 最难的地方是哪里？](#20. 在实际落地中，你觉得 RAG 最难的地方是哪里？)
- [21. 不同来源的文档发生知识冲突时，RAG 应该信谁？](#21. 不同来源的文档发生知识冲突时，RAG 应该信谁？)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/rag_info.html](https://xiaolinnote.com/ai/rag/rag_info.html)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/1_whatisrag.html](https://xiaolinnote.com/ai/rag/1_whatisrag.html)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/2_rag_problems.html](https://xiaolinnote.com/ai/rag/2_rag_problems.html)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/3_rag_vs_finetune.html](https://xiaolinnote.com/ai/rag/3_rag_vs_finetune.html)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/4_chunking.html](https://xiaolinnote.com/ai/rag/4_chunking.html)
...
![](images/f4d0e1bd_img.webp)

所以文档入库的完整流程是这样的：

![](images/e5afe054_img.webp)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/5_semantic_cuts.html](https://xiaolinnote.com/ai/rag/5_semantic_cuts.html)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/6_embedding.html](https://xiaolinnote.com/ai/rag/6_embedding.html)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/7_embedding_algos.html](https://xiaolinnote.com/ai/rag/7_embedding_algos.html)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/8_vectordb.html](https://xiaolinnote.com/ai/rag/8_vectordb.html)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/9_vectordb_practice.html](https://xiaolinnote.com/ai/rag/9_vectordb_practice.html)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/10_online_workflow.html](https://xiaolinnote.com/ai/rag/10_online_workflow.html)
...
![](images/85849df9_img.webp)

![](images/68e695d6_img.webp)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/11_retrieval_types.html](https://xiaolinnote.com/ai/rag/11_retrieval_types.html)
...
![](images/32c774ad_img.webp)

打分的时候核心看两个因素。

![](images/59c14de9_img.webp)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/12_query_rewrite.html](https://xiaolinnote.com/ai/rag/12_query_rewrite.html)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/13_multi_retrieval.html](https://xiaolinnote.com/ai/rag/13_multi_retrieval.html)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/14_retrieval_opt.html](https://xiaolinnote.com/ai/rag/14_retrieval_opt.html)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/15_advanced_paradigms.html](https://xiaolinnote.com/ai/rag/15_advanced_paradigms.html)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/16_graph_db.html](https://xiaolinnote.com/ai/rag/16_graph_db.html)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/17_hallucination.html](https://xiaolinnote.com/ai/rag/17_hallucination.html)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/18_evaluation.html](https://xiaolinnote.com/ai/rag/18_evaluation.html)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/19_dynamic_update.html](https://xiaolinnote.com/ai/rag/19_dynamic_update.html)
...
![](images/8770ce85_img.webp)

### 如何知道文档是否发生了变化？

搞清楚了更新策略是「先删后增」，下一个绕不开的工程问题就是：系统怎么知道一篇文档「变没变」？

![](images/30b2e64e_img.webp)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/20_hardest_parts.html](https://xiaolinnote.com/ai/rag/20_hardest_parts.html)
...
> 原文链接：[https://xiaolinnote.com/ai/rag/21_knowledge_conflict.html](https://xiaolinnote.com/ai/rag/21_knowledge_conflict.html)
