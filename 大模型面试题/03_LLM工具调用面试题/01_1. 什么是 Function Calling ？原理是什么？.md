...
![](images/319c88b0_img.webp)

### 完整的调用流程，两轮对话加中间执行

Function Calling 的运行时本质上是「两轮对话 + 中间执行」的闭环。

![](images/a71ced82_img.webp)
